...
import { funnelTabs, snapshotTabs, storeTabs, UUID, type TabV2 } from "../utils/data";
...
import { AddOp, ConOp, RemOp, SyncOp } from "../utils/sync";
...
export default () => {
  ...
  const test1 = async () => {
    const ci = await Options.TAB_SYNC_INSTANCES.item.getValue();
    Options.TAB_SYNC_INSTANCES.item.setValue([...ci, ...[{
